...
public class Armor {
    ...
    public static final RegistryKey<EquipmentAsset> STELLARIUM_KEY = RegistryKey.of(REGISTRY_KEY, Identifier.of(MythicMinerals.MOD_ID, "frostium"));
    ...
    public static final ArmorMaterial STELLARIUM_ARMOR_MATERIAL = new ArmorMaterial(40, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.BOOTS, 3);
        map.put(EquipmentType.CHESTPLATE, 6);
        map.put(EquipmentType.HELMET, 4);
        map.put(EquipmentType.LEGGINGS, 6);
        map.put(EquipmentType.BODY, 7);
    }),20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0,0, TagsProvider.Items.STELLARIUM_REPAIR, STELLARIUM_KEY);
}
