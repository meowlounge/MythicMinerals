...
import static dev.meowlounge.mythicminerals.item.Utils.*;
...
public class StellariumItems {
    ...
    public static final Item STELLARIUM_SWORD = registerItem("stellarium_sword",
            settings -> new Item(settings.sword(StellariumItems.STELLARIUM_TOOL_MATERIAL, 7, -2.2F)));
    ...
    public static final Item STELLARIUM_AXE = registerItem("stellarium_axe",
            settings -> new AxeItem(StellariumItems.STELLARIUM_TOOL_MATERIAL, 8, -2.8F, settings));
